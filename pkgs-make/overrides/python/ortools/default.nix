...
let
    ...
    cbc = pkgs.cbc.overrideAttrs (oldAttrs: {
        name = "cbc-2.9.9";
        src = pkgs.fetchurl {
    ...
    glog = pkgs.glog.overrideAttrs (oldAttrs: rec {
        name = "glog-${version}";
        version = "0.3.5";
    ...
    protobuf3_3 = pkgs.protobuf.overrideDerivation (oldAttrs: rec {
